...
cp /Users/chmoulli/.m2/repository/com/googlesource/gerrit/plugins/add-user-plugin/2.11.3-SNAPSHOT/add-user-plugin-2.11.3-SNAPSHOT.jar target/gerrit-site/plugins/
